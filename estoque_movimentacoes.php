...
<div class="card">
    <div class="card-body">
        <?php if (count($movimentacoes) > 0): ?>
            ...
            <!-- Área de informação sobre relatórios -->
            <div class="alert alert-info mt-4">
                <i class="fas fa-info-circle me-2"></i>
                Para visualizar relatórios financeiros detalhados, acesse a seção de <a href="relatorio_financeiro.php" class="alert-link">Relatórios Financeiros</a>.
            </div>
        <?php else: ?>
