...
/**
 * Alias para formataValor, para manter compatiblidade
 * 
 * @param float $valor Valor a ser formatado
 * @param string $simbolo Símbolo da moeda
 * @return string Valor formatado
...
function formatarMoeda($valor, $simbolo = 'R$') {
    return formataValor($valor, $simbolo);
}

/**
 * Função para verificar se o usuário tem acesso a uma página/recurso
 * 
 * @param string $permissao Nome da permissão a verificar
 * @return boolean True se tem acesso, False caso contrário
 */
function temPermissao($permissao) {
    ...
    // Usar função de verificar permissão
