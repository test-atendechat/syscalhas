...
$stmt = $pdo->query("SELECT chave, valor FROM configuracoes WHERE chave IN ('horario_inicio', 'horario_fim', 'dias_funcionamento', 'tempo_visita_tecnica', 'aplicar_indisponibilidade_automatica', 'tempo_indisponivel_entrada', 'horario_inicio_almoco', 'horario_fim_almoco') FOR UPDATE");
$config = $stmt->fetchAll(PDO::FETCH_KEY_PAIR);

// Log para debug das configurações carregadas
error_log("Configurações carregadas orçamentistas: tempo_indisponivel_entrada = {$config['tempo_indisponivel_entrada']}");
...
$duracao_minutos = $tempo_visita_tecnica;
